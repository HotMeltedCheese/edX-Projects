...
void print_bricks_with_space(int space, int bricks);

//prints bricks
//takes in the amount of bricks that should be printed
...
int main(void)
{
    ...
    {
        //prints out bricks
        print_bricks_with_space(space, bricks);
        //print out the space between the bricks
        printf("  ");
        //prints out bricks
        print_bricks(bricks);
